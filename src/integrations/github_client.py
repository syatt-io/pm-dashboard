...
class GitHubClient:
    """Client for GitHub API v3 REST API."""

    def __init__(self, api_token: str, organization: str = ""):
        """Initialize GitHub client.

        Args:
            api_token: GitHub personal access token or org token
    ...
    async def search_prs_and_commits(
        ...
        if not self.api_token:
            logger.warning("GitHub API token not configured - skipping GitHub search")
            return {"prs": [], "commits": []}
