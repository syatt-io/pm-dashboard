...
class JobExecution(Base):
    ...
    job_category = Column(String(100), nullable=False, index=True,
    ...
    celery_queue = Column(String(100), nullable=True,
    ...
    __table_args__ = (
        ...
        Index('idx_job_executions_failures', 'job_name', 'started_at',
        ...
        Index('idx_job_executions_recent', 'started_at',
              postgresql_using='btree', postgresql_ops={'started_at': 'DESC'}),
    )

    def __repr__(self):
        return (f"<JobExecution(id={self.id}, job_name='{self.job_name}', "
