...
class BackfillProgress(Base):
    ...
    source = Column(String(50), nullable=False, index=True)  # 'tempo', 'jira', 'notion', etc.
    batch_id = Column(String(100), nullable=False, index=True)  # Unique identifier for this batch
