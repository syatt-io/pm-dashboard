...
# ✅ SECURITY: Exempt Analytics endpoints from CSRF protection
# Analytics endpoints are called from React frontend with JWT auth
csrf.exempt(analytics_bp)
logger.info("✅ Analytics endpoints exempted from CSRF protection")

# ✅ SECURITY: Exempt Forecasts endpoints from CSRF protection
...
# ✅ SECURITY: Exempt Epic Budgets endpoints from CSRF protection
# Epic Budgets endpoints are called from React frontend with JWT auth
csrf.exempt(epic_budgets_bp)
logger.info("✅ Epic Budgets endpoints exempted from CSRF protection")

# ✅ SECURITY: Exempt Epic Categories endpoints from CSRF protection
# Epic Categories endpoints are called from React frontend with JWT auth
