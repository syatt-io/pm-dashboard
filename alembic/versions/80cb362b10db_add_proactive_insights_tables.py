...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_proactive_insights_project_key", "proactive_insights", ["project_key"]
    )
    op.create_index(
        "ix_proactive_insights_insight_type", "proactive_insights", ["insight_type"]
    )
    op.create_index(
        "ix_proactive_insights_created_at", "proactive_insights", ["created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "daily_brief_slack", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "daily_brief_email", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
        ...
        sa.Column(
            "enable_budget_alerts", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
        ...
        sa.Column(
            "enable_anomaly_alerts", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "enable_meeting_prep", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "daily_brief_time", sa.String(5), nullable=False, server_default="09:00"
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_meeting_metadata_normalized_title", "meeting_metadata", ["normalized_title"]
    )
    op.create_index(
        "ix_meeting_metadata_meeting_type", "meeting_metadata", ["meeting_type"]
    )
    op.create_index(
        "ix_meeting_metadata_project_key", "meeting_metadata", ["project_key"]
    )
