...
def upgrade() -> None:
    ...
    # CRITICAL: DO NOT DROP THESE COLUMNS - They are essential project data!
    # These drop commands were commented out after accidentally deleting production data
    # on 2025-11-16. The columns were restored by migration 2069b8009924.
