...
def upgrade() -> None:
    ...
    op.add_column('epic_hours', sa.Column('epic_category', sa.String(100), nullable=True))
    ...
    op.create_index('ix_epic_category_mappings_epic_key', 'epic_category_mappings', ['epic_key'])


def downgrade() -> None:
    """Downgrade schema."""
    # Drop epic_category_mappings table and its indexes
    op.drop_index('ix_epic_category_mappings_epic_key', table_name='epic_category_mappings')
