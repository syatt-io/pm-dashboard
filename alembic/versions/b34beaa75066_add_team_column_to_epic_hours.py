...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_project_epic_month_team', 'epic_hours',
...
def downgrade() -> None:
    ...
    op.create_unique_constraint('uq_project_epic_month', 'epic_hours',
                               ['project_key', 'epic_key', 'month'])
