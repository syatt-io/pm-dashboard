...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('epic_summary', name='uq_epic_baseline_mapping_epic_summary')
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index('ix_epic_baseline_mappings_baseline_category', table_name='epic_baseline_mappings')
    op.drop_index('ix_epic_baseline_mappings_epic_summary', table_name='epic_baseline_mappings')
