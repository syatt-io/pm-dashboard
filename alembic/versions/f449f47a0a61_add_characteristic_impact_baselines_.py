...
def downgrade() -> None:
    ...
    # Drop indexes first
    op.drop_index(
        "ix_characteristic_impact_team", table_name="characteristic_impact_baselines"
    )
    op.drop_index(
        "ix_characteristic_impact_name", table_name="characteristic_impact_baselines"
    )
    op.drop_index(
        "ix_characteristic_impact_lookup", table_name="characteristic_impact_baselines"
    )
