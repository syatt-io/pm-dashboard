...
def upgrade() -> None:
    ...
    op.add_column('processed_meetings', sa.Column('executive_summary', sa.Text(), nullable=True))
    op.add_column('processed_meetings', sa.Column('outcomes', sa.Text(), nullable=True))
    op.add_column('processed_meetings', sa.Column('blockers_and_constraints', sa.Text(), nullable=True))
    op.add_column('processed_meetings', sa.Column('timeline_and_milestones', sa.Text(), nullable=True))
    op.add_column('processed_meetings', sa.Column('key_discussions', sa.Text(), nullable=True))
