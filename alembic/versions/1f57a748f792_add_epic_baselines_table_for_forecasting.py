...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_epic_baselines_epic_category", "epic_baselines", ["epic_category"]
    )
    op.create_index(
        "ix_epic_baselines_variance_level", "epic_baselines", ["variance_level"]
    )
    op.create_index(
        "ix_epic_baselines_project_count", "epic_baselines", ["project_count"]
    )
