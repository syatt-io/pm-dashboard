...
def upgrade() -> None:
    ...
    op.create_index('ix_temporal_pattern_timeline', 'temporal_pattern_baselines', ['timeline_start_pct', 'timeline_end_pct'])
...
def downgrade() -> None:
    ...
    op.drop_index('ix_temporal_pattern_timeline', table_name='temporal_pattern_baselines')
