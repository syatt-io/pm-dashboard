...
def upgrade() -> None:
    ...
    op.create_table(
        "monthly_reconciliation_reports",
    ...
    op.create_index(
        op.f("ix_monthly_reconciliation_reports_month"),
        "monthly_reconciliation_reports",
        ["month"],
        unique=True,
    )
    ...
    op.create_index(
        "idx_user_week",
        "time_tracking_compliance",
        ["user_account_id", "week_start_date"],
        unique=False,
    )
    op.create_index(
        "idx_week_compliance",
        "time_tracking_compliance",
        ["week_start_date", "is_compliant"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        op.f("ix_epic_hours_project_key"), "epic_hours", ["project_key"], unique=False
    )
    op.create_index(op.f("ix_epic_hours_month"), "epic_hours", ["month"], unique=False)
    op.create_index(
        op.f("ix_epic_hours_epic_key"), "epic_hours", ["epic_key"], unique=False
    )
    op.create_table(
        "user_preferences",
    ...
    op.create_table(
        ...
        sa.Column(
            "internal_slack_channels", sa.TEXT(), autoincrement=False, nullable=True
        ),
    ...
    op.drop_index(
        op.f("ix_monthly_reconciliation_reports_month"),
        table_name="monthly_reconciliation_reports",
    )
