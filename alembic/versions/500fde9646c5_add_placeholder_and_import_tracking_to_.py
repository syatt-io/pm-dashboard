...
def upgrade() -> None:
    ...
    op.add_column(
        "epic_budgets",
        sa.Column(
            "is_placeholder", sa.Boolean(), server_default="false", nullable=False
        ),
    )
    op.add_column(
        "epic_budgets", sa.Column("imported_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "epic_budgets", sa.Column("import_source", sa.String(length=50), nullable=True)
    )
