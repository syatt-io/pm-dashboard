...
def upgrade() -> None:
    ...
    op.create_table('tempo_worklogs',
    ...
    op.create_index('ix_tempo_account_team', 'tempo_worklogs', ['account_id', 'team'], unique=False)
    op.create_index('ix_tempo_epic_date', 'tempo_worklogs', ['epic_key', 'start_date'], unique=False)
    op.create_index('ix_tempo_project_date', 'tempo_worklogs', ['project_key', 'start_date'], unique=False)
    op.create_index('ix_tempo_team_date', 'tempo_worklogs', ['team', 'start_date'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_account_id'), 'tempo_worklogs', ['account_id'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_epic_key'), 'tempo_worklogs', ['epic_key'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_issue_key'), 'tempo_worklogs', ['issue_key'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_project_key'), 'tempo_worklogs', ['project_key'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_start_date'), 'tempo_worklogs', ['start_date'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_team'), 'tempo_worklogs', ['team'], unique=False)
    op.create_index(op.f('ix_tempo_worklogs_worklog_id'), 'tempo_worklogs', ['worklog_id'], unique=True)
