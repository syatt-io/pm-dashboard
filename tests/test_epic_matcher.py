...
```"""
    ...
    def test_batch_match_tickets(self):
        ...
        responses = [
            {'suggested_epic_key': 'PROJ-10', 'confidence': 0.90, 'reason': 'Auth related'},
            {'suggested_epic_key': 'PROJ-20', 'confidence': 0.85, 'reason': 'Payment related'},
            {'suggested_epic_key': 'PROJ-30', 'confidence': 0.45, 'reason': 'Low confidence'},  # Below threshold
        ]
