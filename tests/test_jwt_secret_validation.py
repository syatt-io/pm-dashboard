...
class TestJWTSecretValidationWebInterface:
    ...
    def test_production_fails_without_jwt_secret(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'production', 'JWT_SECRET_KEY': ''}, clear=False):
    ...
    def test_production_fails_with_short_jwt_secret(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'production', 'JWT_SECRET_KEY': short_secret}, clear=False):
            with pytest.raises(ValueError) as exc_info:
                import importlib
                import src.web_interface
                importlib.reload(src.web_interface)
    ...
    def test_production_succeeds_with_strong_jwt_secret(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'production', 'JWT_SECRET_KEY': strong_secret}, clear=False):
    ...
    def test_development_allows_missing_jwt_secret(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'development', 'JWT_SECRET_KEY': ''}, clear=False):
            ...
            assert 'dev-secret-DO-NOT-USE-IN-PRODUCTION' in src.web_interface.app.secret_key

    def test_development_allows_short_jwt_secret(self):
        """Test that development mode allows short JWT_SECRET_KEY with warning."""
        short_secret = 'short'

        with patch.dict(os.environ, {'FLASK_ENV': 'development', 'JWT_SECRET_KEY': short_secret}, clear=False):
            # Should not raise an exception in development
            import importlib
            import src.web_interface
            importlib.reload(src.web_interface)
    ...
    def test_jwt_secret_whitespace_handling(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'production', 'JWT_SECRET_KEY': secret_with_whitespace}, clear=False):
            import importlib
            import src.web_interface
            importlib.reload(src.web_interface)
    ...
    def test_weak_secret_pattern_warning(self, caplog):
        ...
        for weak_secret in weak_secrets:
            with patch.dict(os.environ, {'FLASK_ENV': 'development', 'JWT_SECRET_KEY': weak_secret}, clear=False):
                import importlib
                import src.web_interface
                importlib.reload(src.web_interface)
...
class TestJWTSecretMinimumLength:
    ...
    def test_minimum_length_is_32_characters(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'production', 'JWT_SECRET_KEY': almost_valid_secret}, clear=False):
            with pytest.raises(ValueError) as exc_info:
                import importlib
                import src.web_interface
                importlib.reload(src.web_interface)
    ...
    def test_exactly_minimum_length_succeeds(self):
        ...
        with patch.dict(os.environ, {'FLASK_ENV': 'production', 'JWT_SECRET_KEY': valid_secret}, clear=False):
            # Should not raise an exception
            import importlib
            import src.web_interface
            importlib.reload(src.web_interface)
