...
class TestListFeedback:
    ...
    def test_list_feedback_success(
        self, mock_get_user, mock_session, client, auth_headers, mock_feedback_item
    ):
    ...
    def test_list_feedback_with_filter(
        self, mock_session, client, auth_headers, mock_feedback_item
    ):
...
class TestCreateFeedback:
    ...
    def test_create_feedback_missing_type(self, client, auth_headers):
        ...
        response = client.post(
            "/api/feedback", json={"content": "Test content"}, headers=auth_headers
        )
    ...
    def test_create_feedback_missing_content(self, client, auth_headers):
        ...
        response = client.post(
            "/api/feedback", json={"type": "bug"}, headers=auth_headers
        )
    ...
    def test_create_feedback_invalid_type(self, client, auth_headers):
        ...
        response = client.post(
            "/api/feedback",
            json={"type": "invalid_type", "content": "Test content"},
            headers=auth_headers,
        )
